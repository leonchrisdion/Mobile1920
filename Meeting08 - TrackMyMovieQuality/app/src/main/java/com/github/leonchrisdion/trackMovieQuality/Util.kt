package com.github.leonchrisdion.trackMovieQuality
...
fun convertNumericQualityToString(quality: Int, resources: Resources): String {
    ...
    when (quality) {
        ...
        1 -> qualityString = resources.getString(R.string.very_bad)
        2 -> qualityString = resources.getString(R.string.bad)
        3 -> qualityString = resources.getString(R.string.good)
        4 -> qualityString = resources.getString(R.string.very_good)
...
fun convertStringQualityToNumeric(quality: String, resources: Resources): Int {
    ...
    when (quality) {
        ...
        resources.getString(R.string.very_bad) -> qualityInt = 1
        resources.getString(R.string.bad) -> qualityInt = 2
        resources.getString(R.string.good) -> qualityInt = 3
        resources.getString(R.string.very_good) -> qualityInt = 4
        resources.getString(R.string.excellent) -> qualityInt = 5
    }
    return qualityInt
}
